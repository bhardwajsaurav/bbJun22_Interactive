const activeTab = (e, i) => {
  ...
  if (i === 1) {
    document.getElementById("video").src = "look1.mov";
  ...
  if (i === 2) {
    document.getElementById("video").src = "look2.mov";
  ...
  if (i === 3) {
    document.getElementById("video").src = "look3.mov";
    document.getElementById("contain1").style.display = "none";
    document.getElementById("contain2").style.display = "none";
  ...
  if (i === 4) {
    document.getElementById("video").src = "look4.mov";
    document.getElementById("contain1").style.display = "none";
    document.getElementById("contain2").style.display = "none";
    document.getElementById("contain3").style.display = "none";
  ...
  if (i === 5) {
    document.getElementById("video").src = "look5.mov";
    document.getElementById("contain1").style.display = "none";
    document.getElementById("contain2").style.display = "none";
    document.getElementById("contain3").style.display = "none";
    document.getElementById("contain4").style.display = "none";
  ...
  if (i === 6) {
    document.getElementById("video").src = "look6.mov";
  }
};
